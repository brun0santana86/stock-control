...
export class ProductFormComponent implements OnInit, OnDestroy {
  ...
  public productsSelectedDatas!: GetAllProductsResponse;
  ...
  getProductSelectedDatas(productID: string): void {
    ...
    if (allProducts.length > 0) {
      ...
      if (productFiltered) {
        this.productsSelectedDatas = productFiltered[0];

        this.editProductForm.setValue({
          name: this.productsSelectedDatas?.name,
          price: this.productsSelectedDatas?.price,
          amount: this.productsSelectedDatas?.amount,
          description: this.productsSelectedDatas?.description,
        });
      }
    }
  }
